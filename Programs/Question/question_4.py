...
def plot(economy_data_dict):
	...
	plt.savefig("../Figures/question_4_fig.png",bbox_inches='tight')    #Saving the figure in the given paths
	plt.show()


if __name__=="__main__":
	economy_data_dict=execute()
	plot(economy_data_dict)