...
def plot(extra_runs_data_dict):
    ...
    plt.savefig("../Figures/question_3_fig.png",bbox_inches='tight')    #Saving the figure in the given paths
    plt.show()

if __name__=="__main__":
    extra_runs_data_dict=execute()
    plot(extra_runs_data_dict)